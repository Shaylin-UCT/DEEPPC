...
class FIDTests:
    ...
    def processFID(self):
        ...
        for folder in folders:
            #folder = "blocks"
            image_folder = f"/mnt/lustre/users/schetty1/ImagesforResearch/FIDConfirmationImages/CelebAwithDistortions/{folder}"
            ...
            for root, _, files in os.walk(image_folder):
                ...
                param = root[x+1:]
                src_folder = "/mnt/lustre/users/schetty1/ImagesforResearch/FIDConfirmationImages/CelebAwithDistortions/CelebA"
            ...
            #return
            print(csvData)
            self.writeToCSV(f"/home/schetty1/MedFIDAttempt2/ParameterFIDScores/FineTunedCeleb/{folder}.csv", csvData)
